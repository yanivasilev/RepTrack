...
import { formFeedbackApi } from "../../services/api/form-feedback/formFeedbackApi";

type Props = NativeStackScreenProps<FormFeedbackParamList, "FormFeedbackMain">;

const FORM_FEEDBACK_EXERCISES: Exercise[] = [
    {
        id: 1,
        name: "Push-up",
        category: "BODYWEIGHT",
...
export default function FormFeedbackMainScreen({ navigation }: Props) {
    const [selectedExercise, setSelectedExercise] = useState<Exercise | null>(FORM_FEEDBACK_EXERCISES[0]);
    ...
    const handleUploadVideoPress = async () => {
        ...
        try {
            ...
            const analysis = await formFeedbackApi(selectedExercise.id, selectedVideo);
    ...
    return (
        <SafeAreaView style={styles.safe} edges={["top", "left", "right"]}>
            <View style={styles.root}>
                ...
                {/* EXERCISES LIST */}
                <ExercisesList
                    exercises={FORM_FEEDBACK_EXERCISES}
