...
import { Video } from "../../libs/form-feedback/types/Video";
import { estimatePoseOnFrames } from "../../libs/form-feedback/extimatePoseOnFrames";
import { extractFrames } from "../../utils/form-feedback/extractFrames";
import { normaliseFrameTimes } from "../../utils/form-feedback/normaliseFrameTimes";
import { countPushups } from "../../libs/form-feedback/pushup-counter/count-pushups/countPushups";
...
export async function formFeedbackService(exerciseId: number, video: Video) {
